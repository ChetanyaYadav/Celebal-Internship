--This is my personal work uploaded on github only for "Celebal Technology" access using inappropriately can cause Copyright infringement,you need my permission before fair use
--StudentId: CT_CSI_SQ_1260
-- Task 1
